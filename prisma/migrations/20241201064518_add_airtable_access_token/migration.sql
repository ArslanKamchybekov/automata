...
CREATE TABLE "Airtable" (
    "id" TEXT NOT NULL,
    "airtableAccessToken" TEXT NOT NULL,
    "baseId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "Airtable_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "OpenAI_apiKey_key" ON "OpenAI"("apiKey");

-- CreateIndex
CREATE UNIQUE INDEX "Airtable_airtableAccessToken_key" ON "Airtable"("airtableAccessToken");

-- CreateIndex
CREATE UNIQUE INDEX "Airtable_baseId_key" ON "Airtable"("baseId");
...
-- AddForeignKey
ALTER TABLE "OpenAI" ADD CONSTRAINT "OpenAI_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("clerkId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Airtable" ADD CONSTRAINT "Airtable_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("clerkId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Connections" ADD CONSTRAINT "Connections_openaiId_fkey" FOREIGN KEY ("openaiId") REFERENCES "OpenAI"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Connections" ADD CONSTRAINT "Connections_airtableId_fkey" FOREIGN KEY ("airtableId") REFERENCES "Airtable"("id") ON DELETE SET NULL ON UPDATE CASCADE;
